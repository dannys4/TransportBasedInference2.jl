...
@testset "Component function for SparseRadialMapComponent type" begin
    ...
    @test  TransportBasedInference2.component(C, 1).ξk == zeros(2+2)
    @test  TransportBasedInference2.component(C, 1).σk == ones(2+2)
    @test  TransportBasedInference2.component(C, 1).coeffk == zeros(2+3)
    ...
    @test  TransportBasedInference2.component(C, 5).ξk == zeros(2+2)
    @test  TransportBasedInference2.component(C, 5).σk == ones(2+2)
    @test  TransportBasedInference2.component(C, 5).coeffk == zeros(2+3)

    @test  TransportBasedInference2.component(C, 2).ξi == zeros(2)
    @test  TransportBasedInference2.component(C, 2).σi == ones(2)
    @test  TransportBasedInference2.component(C, 2).coeffi == zeros(2+1)
    ...
    for i=1:4
        @test TransportBasedInference2.component(C, i).p == C.p[i]
        @test typeof(TransportBasedInference2.component(C, i))<:ui
        @test  TransportBasedInference2.component(C, i).ξi == zeros(solξ[i])
        @test  TransportBasedInference2.component(C, i).σi == ones(solσ[i])
        @test  TransportBasedInference2.component(C, i).coeffi == zeros(sola[i])
    end

    for i=5:5
        @test TransportBasedInference2.component(C, i).p == C.p[i]
        @test typeof(TransportBasedInference2.component(C, i))<:uk
        @test  TransportBasedInference2.component(C, i).ξk == zeros(solξ[i])
        @test  TransportBasedInference2.component(C, i).σk == ones(solσ[i])
        @test  TransportBasedInference2.component(C, i).coeffk == zeros(sola[i])
    end
...
@testset "Verify off_diagonal function" begin
    ...
    z = randn(3)
    @test norm(off_diagonal(C, z) - (C(z) - TransportBasedInference2.component(C,3)(z[3])))<1e-10
